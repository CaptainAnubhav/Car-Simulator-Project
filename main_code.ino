...
void loop() {
  ...
  int new_steeringwheelValue=map(steeringwheelValue,80,548,0,127);
  int new_steeringwheelValue1=map(steeringwheelValue,549,900,128,255);
  if (steeringwheelValue < 548)
  {
